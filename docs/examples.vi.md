...
Tài liệu này cung cấp các ví dụ thực tế về cách sử dụng `@emlinh-ai/types` trong các tình huống khác nhau.
...
### Validate với Custom Error Handling
